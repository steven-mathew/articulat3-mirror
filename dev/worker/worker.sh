...
cat <<EOT > /home/$username/run-worker-process.sh
...
chmod 700 /home/$username/run-worker-process.sh

singularity exec --fakeroot --writable --nv --network "host" /home/$username/box /home/$username/run-worker-process.sh
